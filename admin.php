...
<div id="content">
    <div class="tabPg">
        <a href="javascript:void(0)" class="tabs active" onclick="openTab(event, 'create_account')">Create New
            Account</a>
    ...
    <div id="create_account" class="tabcontent">
        <form method="post" action="">
            <label for="name">Username
                <input name="create_username" type="text" class="form-control"
                       id="name" <?php if (isset($_POST["create_username"])) echo "value=\"{$_POST["create_username"]}\""; ?>/>
            </label>

            <label for="password">Password
                <input name="create_password" type="text" class="form-control"
                       id="password" <?php if (isset($_POST["create_password"])) echo "value=\"{$_POST["create_password"]}\""; ?>/>
            </label>
            ...
            <label for="firstName">First Name
                <input name="create_firstName" type="text" class="form-control"
                       id="firstName" <?php if (isset($_POST["create_firstName"])) echo "value=\"{$_POST["create_firstName"]}\""; ?>/>
            </label>

            <label for="lastName">Last Name
                <input name="create_lastName" type="text" class="form-control"
                       id="lastName" <?php if (isset($_POST["create_lastName"])) echo "value=\"{$_POST["create_lastName"]}\""; ?>/>
            </label>

            <label for="mail">Email
                <input name="create_mail" type="text" class="form-control"
                       id="mail" <?php if (isset($_POST["create_mail"])) echo "value=\"{$_POST["create_mail"]}\""; ?>/>
            </label>
            ...
            <label for="create_role">Role
                <select name="create_role" class="form-control"
                        id="create_role" <?php if (isset($_POST["create_role"])) echo "value=\"{$_POST["create_role"]}\""; ?>>
    ...
    <div id="edit_account" class="tabcontent">
        ...
        <form method="post" action="">
            <input type="hidden" id="current-edit"
                   name="edit-uid" <?php if (isset($result["user_id"])) echo "value=\"{$result["user_id"]}\""; ?>/>
            <label for="editname">Username
                <input name="edit_username" type="text" class="form-control"
                       id="editname" <?php if (isset($result["username"])) echo "value=\"{$result["username"]}\""; ?>/>
            </label>

            <label for="editpassword">Password
                <input name="edit_password" type="text" class="form-control"
                       id="editpassword" <?php if (isset($result["user_password"])) echo "value=\"{$result["user_password"]}\""; ?>/>
            </label>
            ...
            <label for="editfirstName">First Name
                <input name="edit_firstName" type="text" class="form-control"
                       id="editfirstName" <?php if (isset($result["first_name"])) echo "value=\"{$result["first_name"]}\""; ?>/>
            </label>

            <label for="editlastName">Last Name
                <input name="edit_lastName" type="text" class="form-control"
                       id="editlastName" <?php if (isset($result["last_name"])) echo "value=\"{$result["last_name"]}\""; ?>/>
            </label>

            <label for="editmail">Email
                <input name="edit_mail" type="text" class="form-control"
                       id="editmail" <?php if (isset($result["userEmail"])) echo "value=\"{$result["userEmail"]}\""; ?>/>
            </label>
            ...
            <label for="edit_role">Role
                <input type="hidden"
                       id="role-sel-val" <?php if (isset($result["role_id"])) echo "value=\"{$result["role_id"]}\""; ?>/>
